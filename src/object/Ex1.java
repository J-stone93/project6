...
public class Ex1 {
	...
	public static void main(String[] args) {
		...
		Student student = new Student("둘리", 10000); // 만원을 가진 둘리
		
		Bus bus = new Bus(100); //100번 버스 만든다
		
		student.takeBus(bus); //둘리가 100번 버스를 탄다
		
		student.showInfo(); //이후 학생의 정보를 확인
		
		bus.showInfo(); //이후 버스의 정보를 확인
